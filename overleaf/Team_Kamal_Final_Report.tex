...
\hypersetup{
  ...
  linkcolor=blue,
  urlcolor=blue,
  pdftitle={Team Kamal - Final Technical Report},
  pdfauthor={Team Kamal}
}

\title{\textbf{Team Kamal Final Technical Report}\\
...
\end{tikzpicture}
\caption{End-to-end architecture implemented by Team Kamal.}
\end{figure}
...
\centering
\begin{tikzpicture}[
  n/.style={draw, rounded corners=2pt, align=center, minimum width=3.1cm, minimum height=8mm, fill=gray!8},
  arr/.style={-{Latex[length=2mm]}, thick}
]
...
\section{Conclusion}
Team Kamal's final system couples reliable numerical propagation with scalable spatial risk screening and constrained control planning in a clean service architecture. The resulting platform is both technically rigorous and operationally usable for live mission-style demonstrations.
